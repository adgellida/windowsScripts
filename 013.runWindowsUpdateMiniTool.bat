...
cd..
cd downloads
@powershell -NoProfile -ExecutionPolicy Bypass -Command "$source = 'http://www.adgellida.byethost7.com/files/wumt.zip'; $destination = 'wumt.zip'; Invoke-WebRequest $source -OutFile $destination;
