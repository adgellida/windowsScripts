...
cd..
cd downloads
@powershell -NoProfile -ExecutionPolicy Bypass -Command "$source = 'https://github.com/processhacker2/processhacker2/releases/download/v2.39/processhacker-2.39-bin.zip'; $destination = 'processhacker-2.39-bin.zip'; Invoke-WebRequest $source -OutFile $destination;
